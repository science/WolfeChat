  ...
  <div class="fixed z-50 inset-0 overflow-y-auto animate-fade-in">
    <div class="flex items-center justify-center min-h-screen">
      <div class="bg-primary text-white rounded-lg shadow-xl p-8 relative max-w-lg mx-4">
        ...
        <h2 class="text-xl font-bold mb-4">WolfeChat Help & FAQ</h2>
        <div class="text-left">
          ...
          <p class="mb-4"><strong>That’s where WolfeChat comes in.</strong> WolfeChat provides a clean, familiar UI for using your own OpenAI API key.</p>
  
          <h2 class="text-2xl font-bold mb-3">Key Features:</h2>
          <h3 class="text-xl font-bold mb-2">Credits</h3>
            <p class="mb-3">WolfeChat stands on the shoulders of great projects. Huge thanks to:</p>
            <ul class="list-disc list-inside mb-4">
              <li><a href="https://github.com/patrikzudel/PatrikZeros-ChatGPT-API-UI" target="_blank" rel="noreferrer" class="underline">PatrikZeros-ChatGPT-API-UI</a> by patrikzudel</li>
              <li><a href="https://github.com/agambon/SmoothGPT" target="_blank" rel="noreferrer" class="underline">SmoothGPT</a> and its contributors</li>
            </ul>
          ...
          <div class="mb-1 mt-4">
              <a href="https://github.com/stevewolesky/wolfechat" target="_blank" rel="noreferrer"  class="text-blue-500 hover:text-blue-700">See the WolfeChat source</a>
          </div>
          <div class="mb-1">
          ...
          <div class="mb-4">
              <a href="https://github.com/billmei/every-chatgpt-gui" target="_blank" rel="noreferrer"  class="text-blue-500 hover:text-blue-700">Explore other open-source ChatGPT UIs</a>
          </div>
